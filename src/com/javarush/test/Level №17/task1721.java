...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
            ...
            BufferedReader reader2 = new BufferedReader(new InputStreamReader(new FileInputStream(reader1.readLine())));
            BufferedReader reader3 = new BufferedReader(new InputStreamReader(new FileInputStream(reader1.readLine())));
            reader1.close();
    ...
    public void joinData() throws CorruptedDataException {
        boolean RemLineContainedAllLines = allLines.containsAll(forRemoveLines);
        if (RemLineContainedAllLines){
